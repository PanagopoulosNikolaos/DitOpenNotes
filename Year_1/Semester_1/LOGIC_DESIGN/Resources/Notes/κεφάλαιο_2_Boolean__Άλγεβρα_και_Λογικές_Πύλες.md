...
### Άσκηση 1: Απόδειξη Ταυτοδυναμίας $x+x=x$
**Πρόβλημα:**
...
### Άσκηση 2: Απλοποίηση Συνάρτησης
**Πρόβλημα:**
...
### Άσκηση 3: Εύρεση Συμπληρώματος Συνάρτησης με DeMorgan
**Πρόβλημα:**
...
### Άσκηση 4: Έκφραση Συνάρτησης ως Άθροισμα Ελαχιστόρων (Sum of Minterms)
**Πρόβλημα:**
...
### Άσκηση 5: Έκφραση Συνάρτησης ως Γινόμενο Μεγιστόρων (Product of Maxterms)
**Πρόβλημα:**
...
### Άσκηση 6: Μετατροπή μεταξύ Κανονικών Μορφών
**Πρόβλημα:**
...
### Άσκηση 7: Αλγεβρική Απόδειξη Consensus Theorem
**Πρόβλημα:**
...
## Συμβουλή Εξετάσεων: Ορισμός minterms / maxterms
