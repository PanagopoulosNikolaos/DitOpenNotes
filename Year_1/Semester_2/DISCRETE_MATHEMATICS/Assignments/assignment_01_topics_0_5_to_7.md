...
Η **αρχή της μαθηματικής επαγωγής** είναι μια ισχυρή αποδεικτική τεχνική που χρησιμοποιείται για να αποδειχθεί ότι μια πρόταση $P(n)$ ισχύει για όλους τους φυσικούς αριθμούς $n$ που είναι μεγαλύτεροι ή ίσοι με έναν αρχικό αριθμό $n_0$.
