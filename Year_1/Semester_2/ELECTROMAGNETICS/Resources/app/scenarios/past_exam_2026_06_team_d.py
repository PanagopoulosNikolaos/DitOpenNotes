        ...
        ExamQuestion(
            ...
            calculation_steps=[
                CalculationStep(
                    ...
                    substitution=r"\rho = \frac{\partial}{\partial x}(-x) + \frac{\partial}{\partial y}(0) + \frac{\partial}{\partial z}(z^2 y)",
                    result=r"\rho = -1 + 0 + 2zy = 2zy - 1",
                    rationale=r"Η παράγωγος του -x ως προς x είναι -1. Η παράγωγος του z²y ως προς z είναι 2zy.",
                ),
            ],
        ...
        ExamQuestion(
            ...
            calculation_steps=[
                CalculationStep(
                    ...
                    substitution=r"f = \frac{3\times 10^9}{2\pi} \approx 4.7746 \times 10^8 \ \text{Hz} = 477.46 \ \text{MHz}, \quad k = \frac{3\times 10^9}{3\times 10^8} = 10 \ \text{rad/m}",
                    result=r"f \approx 477.5 \ \text{MHz}, \quad k = 10 \ \text{rad/m}",
                    rationale="Η συχνότητα 477.5 MHz βρίσκεται στη ζώνη τηλεοπτικών εκπομπών UHF.",
                ),
                CalculationStep(
                    step_number=2,
                    title="Υπολογισμός μήκους κύματος λ",
                    formula=r"\lambda = \frac{2\pi}{k} = \frac{c}{f}",
                    substitution=r"\lambda = \frac{2\pi}{10} = 0.2\pi \approx 0.6283 \ \text{m} = 62.83 \ \text{cm}",
                    result=r"\lambda \approx 0.6283 \ \text{m} = 62.83 \ \text{cm}",
                    rationale="Από τον ορισμό λ = 2π/k.",
                ),
                CalculationStep(
                    step_number=3,
                    title="Προσδιορισμός διανύσματος μαγνητικής επαγωγής B",
                    formula=r"B_0 = \frac{E_0}{c}, \quad \hat{E} \times \hat{B} = \hat{k} \implies \hat{y} \times \hat{B} = \hat{x} \implies \hat{B} = \hat{z}",
                    substitution=r"B_0 = \frac{60}{3\times 10^8} = 2\times 10^{-7} \ \text{T}, \quad \hat{y} \times \hat{z} = \hat{x}",
                    result=r"\vec{B}(x,t) = 2\times 10^{-7}\cos(10x - 3\cdot 10^9 t)\hat{z} \ \text{T}",
                    rationale="Επειδή E είναι κατά y και η διάδοση κατά x, το εξωτερικό γινόμενο ŷ × ẑ = x̂ επιβάλλει B κατά +z.",
                ),
                CalculationStep(
                    step_number=4,
                    title="Υπολογισμός διανύσματος Poynting S",
                    formula=r"\vec{S} = \frac{1}{\mu_0}(\vec{E}\times\vec{B})",
                    substitution=r"\vec{S} = \frac{1}{4\pi\times 10^{-7}} [60 \cos(...) \hat{y} \times 2\times 10^{-7} \cos(...) \hat{z}] = \frac{120 \times 10^{-7}}{4\pi \times 10^{-7}}\cos^2(...)\hat{x}",
                    result=r"\vec{S} = \frac{30}{\pi} \cos^2(10x - 3\cdot 10^9 t)\hat{x} \approx 9.549 \cos^2(...)\hat{x} \ \text{W/m}^2",
                    rationale="Η ροή ενέργειας κατευθύνεται κατά τον θετικό άξονα x.",
                ),
                CalculationStep(
                    step_number=5,
                    title="Υπολογισμός μέσης έντασης ακτινοβολίας I",
                    formula=r"I = \bar{S} = \frac{S_0}{2} = \frac{1}{2}\frac{30}{\pi}",
                    substitution=r"I = \frac{15}{\pi} \approx 4.775 \ \text{W/m}^2",
                    result=r"I \approx 4.775 \ \text{W/m}^2",
