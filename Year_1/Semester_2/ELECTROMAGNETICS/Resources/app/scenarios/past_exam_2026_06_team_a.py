    ...
    questions = [
        ...
        ExamQuestion(
            ...
            calculation_steps=[
                CalculationStep(
                    step_number=1,
                    title="Εφαρμογή μερικών παραγώγων του τελεστή απόκλισης",
                    formula=r"\rho = \vec{\nabla}\cdot\vec{D} = \frac{\partial D_x}{\partial x} + \frac{\partial D_y}{\partial y} + \frac{\partial D_z}{\partial z}",
                    substitution=r"\rho = \frac{\partial}{\partial x}(x^2 z) + \frac{\partial}{\partial y}\left(\frac{3}{y}\right) + \frac{\partial}{\partial z}(0)",
                    result=r"\rho = 2xz - \frac{3}{y^2}",
                    rationale=r"Η παράγωγος του x²z ως προς x είναι 2xz. Η παράγωγος του 3/y = 3 y^(-1) ως προς y είναι -3 y^(-2) = -3/y².",
                ),
            ],
        ...
        ExamQuestion(
            ...
            calculation_steps=[
                CalculationStep(
                    ...
                    substitution=r"f = \frac{10^{11}}{2\pi} \approx 1.5915 \times 10^{10} \ \text{Hz} \ (15.92 \ \text{GHz}), \quad k = \frac{10^{11}}{3\times 10^8} = \frac{1000}{3} \ \text{rad/m}",
                    result=r"f \approx 1.59 \times 10^{10} \ \text{Hz}, \quad k \approx 333.33 \ \text{rad/m}",
                    rationale="Η κυκλική συχνότητα 10^11 rad/s αντιστοιχεί στη ζώνη των μικροκυμάτων.",
                ),
                CalculationStep(
                    step_number=2,
                    title="Υπολογισμός μήκους κύματος λ",
                    formula=r"\lambda = \frac{c}{f} = \frac{2\pi}{k}",
                    substitution=r"\lambda = \frac{3\times 10^8}{1.5915 \times 10^{10}} = \frac{3}{1000} \cdot 2\pi \approx 0.01885 \ \text{m} = 1.885 \ \text{cm}",
                    result=r"\lambda \approx 1.885 \ \text{cm} = 0.01885 \ \text{m}",
                    rationale="Υπολογίζεται απευθείας από τη σχέση λ = c/f.",
                ),
                CalculationStep(
                    step_number=3,
                    title="Προσδιορισμός διανύσματος μαγνητικής επαγωγής B",
                    formula=r"B_0 = \frac{E_0}{c}, \quad \hat{B} = \hat{k} \times \hat{E} \implies \hat{y} \times \hat{z} = \hat{x}",
                    substitution=r"B_0 = \frac{30}{3\times 10^8} = 10^{-7} \ \text{T}, \quad \hat{B} = \hat{x}",
                    result=r"\vec{B}(y,t) = 10^{-7}\cos\left(\frac{1000}{3}y - 10^{11}t\right)\hat{x} \ \text{T}",
                    rationale="Επειδή E είναι κατά ẑ και η διάδοση κατά ŷ, έχουμε ẑ x x̂ = ŷ, συνεπώς το B ταλαντώνεται κατά +x̂.",
                ),
                CalculationStep(
                    step_number=4,
                    title="Υπολογισμός διανύσματος Poynting S",
                    formula=r"\vec{S} = \frac{1}{\mu_0}(\vec{E}\times\vec{B})",
                    substitution=r"\vec{S} = \frac{1}{4\pi\times 10^{-7}} [30 \cos(...) \hat{z} \times 10^{-7} \cos(...) \hat{x}] = \frac{30 \times 10^{-7}}{4\pi \times 10^{-7}} \cos^2(...)\hat{y}",
                    result=r"\vec{S} = \frac{30}{4\pi} \cos^2\left(\frac{1000}{3}y - 10^{11}t\right)\hat{y} \approx 2.387 \cos^2(...)\hat{y} \ \text{W/m}^2",
                    rationale="Το εξωτερικό γινόμενο ẑ x x̂ δίνει ŷ, αποδεικνύοντας ότι η ροή ενέργειας συμπίπτει με τη διεύθυνση διάδοσης του κύματος.",
                ),
                CalculationStep(
                    step_number=5,
                    title="Υπολογισμός μέσης έντασης ακτινοβολίας I",
                    formula=r"I = \bar{S} = \frac{S_0}{2} = \frac{1}{2}\frac{30}{4\pi}",
                    substitution=r"I = \frac{15}{4\pi} \approx 1.194 \ \text{W/m}^2",
                    result=r"I \approx 1.194 \ \text{W/m}^2",
