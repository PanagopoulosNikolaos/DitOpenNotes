...
⚠️ **Ο κόμβος 10 έχει BF = +2** → Χρειάζεται **επαναισορρόπηση**!
...
⚠️ **Μη ισορροπία**: BF(30) = +2 → Χρειάζεται **δεξιά περιστροφή**!
...
⚠️ **Μη ισορροπία**: BF(30) = +2, BF(10) = -1 → **Left-Right περιστροφή**!
...
⚠️ **Μη ισορροπία**: BF(20) = -2 → **Αριστερή περιστροφή**!
...
⚠️ **Μη ισορροπία**: BF(20) = -2, BF(30) = +1 → **Right-Left περιστροφή**!
