...
def renderHeader(current_scenario: Scenario, on_scenario_change: Callable[[str], None]) -> dict:
    ...
    with ui.header().classes(
        ...
        with ui.row().classes("items-center gap-4"):
            ...
            with ui.column().classes("gap-0"):
                ...
                subtitle_label = ui.label(current_scenario.subtitle).classes("text-xs text-[#b5b0a4]")
        ...
        with ui.row().classes("items-center gap-3 flex-wrap"):
            ...
            with ui.row().classes(
                ...
                course_label = ui.label(current_scenario.course_tag)
