            ...
            with ui.column().classes("w-full glass-panel gap-4 print-section print-sql-ddl"):
                with ui.row().classes("w-full justify-between items-center flex-wrap gap-2 border-b border-[rgba(255,255,255,0.08)] pb-3"):
                    ...
                    ui.button(
                        ...
                        "text-xs text-[#fdba74] border-[rgba(224,107,58,0.4)] hover:bg-[#e06b3a]/20 no-print"
                    )

                with ui.column().classes("w-full rounded-xl overflow-hidden print:overflow-visible bg-[#10100f] border border-[rgba(255,255,255,0.08)] p-4 sql-code-container"):
