...
def createHotelManagementScenario() -> Scenario:
    ...
    keys_analysis = [
        KeyAnalysisRow(
            entity_name="ΞΕΝΟΔΟΧΕΙΑΚΗ_ΜΟΝΑΔΑ (Hotel Resort)",
        ...
        KeyAnalysisRow(
            entity_name="ΚΡΑΤΗΣΗ (Booking / Reservation)",
        ...
        KeyAnalysisRow(
            entity_name="ΥΠΗΡΕΣΙΑ (Extra Service)",
            key_count="1 Υποψήφιο",
