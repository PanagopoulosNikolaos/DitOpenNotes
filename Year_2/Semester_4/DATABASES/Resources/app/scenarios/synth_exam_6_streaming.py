...
def createStreamingPlatformScenario() -> Scenario:
    ...
    entities = [
        ...
        Entity(
            ...
            attributes=[
                Attribute("isan", "Απλό / Μονότιμο", is_pk=True, is_fk=False, notes="ISAN ταινίας (PK & FK στο ΕΡΓΟ)"),
    ...
    relationship_attributes = [
        RelationshipAttribute(
            name="idiotita",
            relationship_name="ΣΥΜΜΕΤΟΧΗ_ΣΕ_ΕΡΓΟ (Cast Participation)",
        ...
        RelationshipAttribute(
            ...
            relationship_name="ΙΣΤΟΡΙΚΟ_ΘΕΑΣΗΣ_ΚΑΙ_ΑΞΙΟΛΟΓΗΣΗ (Viewing & Rating)",
    ...
    keys_analysis = [
        KeyAnalysisRow(
            entity_name="ΕΡΓΟ (Audiovisual Title / Media Item)",
        ...
        KeyAnalysisRow(
            entity_name="ΤΗΛΕΟΠΤΙΚΗ_ΣΕΙΡΑ (TV Series)",
            key_count="1 Υποψήφιο (Κληρονομούμενο)",
            key_types="Υποψήφιο: {isan}",
            final_pk_selection="isan",
        ...
        KeyAnalysisRow(
            entity_name="ΣΥΝΤΕΛΕΣΤΗΣ (Cast & Crew)",
            key_count="1 Υποψήφιο",
        ...
        KeyAnalysisRow(
            entity_name="ΣΥΝΔΡΟΜΗΤΗΣ (Subscriber)",
        ...
        KeyAnalysisRow(
            entity_name="ΠΡΟΦΙΛ_ΧΡΗΣΤΗ (User Profile)",
