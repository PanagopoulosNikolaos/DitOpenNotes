    ...
    paragraphs = [
        ...
        Paragraph(
            segments=[
                ...
                TextSegment(
                    ...
                    tooltip="Πλειότιμο Γνώρισμα / Ασθενής Οντότητα: Εξάγεται στον πίνακα EGKATASTASI_SCHOLIS.",
                ),
                TextSegment(text="."),
            ],
            accent_border_color=None,
        ...
        Paragraph(
            segments=[
                ...
                TextSegment(text="ανήκει σε μία σχολή", is_highlight=True, category="rel", tag_label="ΣΧΕΣΗ N:1", badge_class="badge-rel"),
                TextSegment(text=" και μπορεί να "),
                TextSegment(text="διδάσκει σε πολλά προγράμματα", is_highlight=True, category="rel", tag_label="ΣΧΕΣΗ N:M", badge_class="badge-rel"),
                TextSegment(text=" (με καταγραφή των "),
                TextSegment(text="εβδομαδιαίων ωρών διδασκαλίας", is_highlight=True, category="attr", tag_label="ΓΝΩΡΙΣΜΑ ΣΧΕΣΗΣ", badge_class="badge-attr-simple"),
                TextSegment(text=")."),
            ],
            accent_border_color=None,
        ),
        Paragraph(
            segments=[
                TextSegment(text="4. <strong>Εξαρτώμενα Μέλη:</strong> Για τα εξαρτώμενα μέλη των καθηγητών καταγράφονται: "),
                TextSegment(text="όνομα", is_highlight=True, category="key", tag_label="PARTIAL KEY", badge_class="badge-key-partial"),
                TextSegment(text=", "),
                TextSegment(text="φύλο", is_highlight=True, category="attr", tag_label="ΓΝΩΡΙΣΜΑ", badge_class="badge-attr-simple"),
                TextSegment(text=", "),
                TextSegment(text="ημερομηνία γέννησης", is_highlight=True, category="attr", tag_label="ΓΝΩΡΙΣΜΑ", badge_class="badge-attr-simple"),
