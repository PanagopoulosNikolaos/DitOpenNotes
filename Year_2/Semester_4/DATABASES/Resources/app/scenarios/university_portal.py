...
def createUniversityPortalScenario() -> Scenario:
    ...
    entities = [
        ...
        Entity(
            ...
            entity_type="Ισχυρή Οντότητα (Strong Entity)",
            is_weak=False,
            justification="Φυσικό πρόσωπο διδάσκοντα με μοναδικό αναγνωριστικό το ΑΦΜ.",
            attributes=[
        ...
        Entity(
            ...
            entity_type="Ισχυρή Οντότητα (Strong Entity)",
            is_weak=False,
            justification="Φυσικό πρόσωπο εκπαιδευόμενου με μοναδικό Αριθμό Μητρώου (ΑΜ).",
            attributes=[
