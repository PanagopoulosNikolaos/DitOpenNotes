    ...
    paragraphs = [
        ...
        Paragraph(
            segments=[
                ...
                TextSegment(
                    text="μοναδική ονομασία (π.χ. 'Καρδιολογική', 'Νευρολογική')",
                    is_highlight=True,
                    category="key",
                ...
                TextSegment(
                    text="εξειδικευμένες πτέρυγες/εγκαταστάσεις που βρίσκονται σε διάφορα κτίρια του νοσοκομειακού συγκροτήματος (πολλαπλές τοποθεσίες)",
                    is_highlight=True,
                    category="attr",
                    tag_label="ΠΛΕΙΟΤΙΜΟ",
        ...
        Paragraph(
            segments=[
                ...
                TextSegment(text=", "),
                TextSegment(text="βαθμίδα (π.χ. Επιμελητής Α', Επιμελητής Β', Διευθυντής)", is_highlight=True, category="attr", tag_label="ΓΝΩΡΙΣΜΑ", badge_class="badge-attr-simple"),
                TextSegment(text=", "),
                ...
                TextSegment(
                    text="διεύθυνση κατοικίας (αποτελούμενη από οδό, αριθμό, ταχυδρομικό κώδικα και πόλη)",
                    is_highlight=True,
                    category="attr",
                    tag_label="ΣΥΝΘΕΤΟ",
                ...
                TextSegment(text=" νεότερους ειδικευόμενους ιατρούς (κάθε ειδικευόμενος έχει έναν άμεσο επόπτη ιατρό, ενώ ένας επόπτης μπορεί να καθοδηγεί πολλούς ειδικευόμενους)."),
            ],
        ...
        Paragraph(
            segments=[
                ...
                TextSegment(text=". Το όνομα του εξαρτώμενου μέλους είναι μοναδικό μόνο στα πλαίσια της οικογένειας του συγκεκριμένου ιατρού."),
            ],
        ...
        Paragraph(
            segments=[
                ...
                TextSegment(text=" και η "),
                TextSegment(
                    text="τρέχουσα ηλικία του (η οποία υπολογίζεται δυναμικά από την ημερομηνία γέννησης)",
                    is_highlight=True,
                    category="attr",
                    tag_label="ΠΑΡΑΓΩΓΟ",
        ...
        Paragraph(
            segments=[
                ...
                TextSegment(text=", η "),
                TextSegment(text="ημερομηνία και ώρα εξιτηρίου (εφόσον έχει ολοκληρωθεί)", is_highlight=True, category="attr", tag_label="ΓΝΩΡΙΣΜΑ", badge_class="badge-attr-simple"),
                TextSegment(text=", ο "),
                ...
                TextSegment(text=" και πραγματοποιείται σε μία κλινική."),
            ],
        ...
        Paragraph(
            segments=[
                ...
                TextSegment(text=" στον νοσηλευόμενο ασθενή. Για κάθε χορήγηση φαρμάκου σε μια συγκεκριμένη νοσηλεία καταγράφονται: η "),
                TextSegment(
                    text="δοσολογία",
                    is_highlight=True,
                    category="attr",
