# Database Exams & Practice Papers Directory

Welcome to the **Databases Exam Preparation Hub**. This directory contains past exam papers, topic-focused synthetic practice drills, and realistic scenario-based mock exams.
...
```
Exams/
├── README.md                                       # Master index and navigation guide (this file)
├── images/                                         # ER diagrams and exam paper scan references
│   ├── Exam_paper_27_4_2026.png                    # Exam paper scan (27/4/2026)
│   ├── Exam_paper_null_null_null.png               # Standard final exam paper template layout
│   └── hospital-er-diagram-1.png                   # Hospital ER diagram reference asset
└── Papers/                                         # Consolidated examination papers
    ├── Past_Exam_1.md                              # Past Exam 1 (Educational Institution ER & Schema)
    ├── Past_Exam_2.md                              # Past Exam 2 (Research Institute ER & Schema - 27/4/2026)
    ├── synth_full_coverage/                        # Topic-focused comprehensive practice drills
    ...
    └── synth_realistic/                            # Realistic scenario-based exam papers
        ├── exam_paper_synthetic_and_realistic_1.md # Hospital Management System
        ├── exam_paper_synthetic_and_realistic_2.md # University Academic System
        ├── exam_paper_synthetic_and_realistic_3.md # Airline Flight Reservation System
        ├── exam_paper_synthetic_and_realistic_4.md # Hotel Chain Management System
        ├── exam_paper_synthetic_and_realistic_5.md # E-Commerce & Retail Marketplace
        ├── exam_paper_synthetic_and_realistic_6.md # Video Streaming Platform
        ├── exam_paper_synthetic_and_realistic_7.md # Municipal Library Network
...
## Topic-Focused Practice Drills (`synth_full_coverage`)
...
## Realistic Scenario-Based Exams (`synth_realistic`)
